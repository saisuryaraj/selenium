...
public class FDCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String filePath= "D:\\Eclipse\\workspace\\selenium\\testdata\\caldata.xlsx";
		...
		{	
			...
			//validation
			String act_mvalue =driver.findElement(By.xpath("//span[@class='gL_27']")).getText();
